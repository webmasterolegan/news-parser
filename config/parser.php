...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Регулярное выражение для опредения расширения изиброжения из URL
    |--------------------------------------------------------------------------
    */
    'images_ext_reg' => '/.*\.(jpeg|jpg|png|webp|gif){1}$/i',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | GET переменная содержащая запрашиваемые атрибуты
    |--------------------------------------------------------------------------
    */
